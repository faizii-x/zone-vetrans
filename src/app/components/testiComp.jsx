...
function TestiComp() {
  return (
    <>
      <h1 className="w-[90%] mx-auto text-[34px] font-poppins font-bold mt-[160px]">
        Testimonials
      </h1>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:w-[90%] w-[97%] container mx-auto mt-10">
        <div className="col-span-1 p-3 mx-auto">
          <div className="bg-red xl:w-[80%] w-full rounded-xl h-[273px] p-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-[90%] container mx-auto mt-10">
        ...
        <div className="col-span-1 p-3 mx-auto">
          <div className="bg-red lg:w-[80%] w-full rounded-xl h-[273px] p-6">
            <div className="xl:flex grid xl:justify-start justify-center">
              <div className="">
                <h3 className="text-white text-[17px] font-poppins font-semibold mt-10">
                  Julianne Blackwell
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 w-[90%] container mx-auto mt-10">
        <div className="col-span-1 p-3 mx-auto lg:mt-0 mt-16">
          <div className="bg-red lg:w-[80%] w-full rounded-xl h-[273px] p-6">
            <div className="xl:flex grid xl:justify-start justify-center">
              <div className="">
                <h3 className="text-white text-[17px] font-poppins font-semibold mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-[90%] container mx-auto mt-10">
        ...
        <div className="col-span-1 p-3 mx-auto">
          <div className="bg-red lg:w-[80%] w-full rounded-xl h-[273px] p-6 lg:mb-0 mb-16">
            <div className="xl:flex grid xl:justify-start justify-center">
              <div className="">
                <h3 className="text-white text-[17px] font-poppins font-semibold mt-10">
                  Harmony Holloway
